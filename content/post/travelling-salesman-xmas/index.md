...
projects: []
---
My local village has set up a lovely Christmas trail this year, with houses going overboard with flashing lights and decorations being listed on a charity produced map. It's a delightful idea, but as with all villages that have grown organically from their Doomsday routes, planning the optimal route round all the twisting roads is a non-trivial problem.
